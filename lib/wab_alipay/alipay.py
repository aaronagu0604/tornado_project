...
class Alipay:
    ...
    def create_payurl(self, tn, subject, body, total_fee, is_bank=''):
        params = {}
    ...
    def notify_verify(self, post):
        ...
        ucode = urlencode(params)
        ssl._create_default_https_context = ssl._create_unverified_context
        veryfy_result = urlopen(self._GATEWAY, ucode).read()
    ...
    def send_goods_confirm_by_platform(self, tn):
        ...
        params['_input_charset'] = self.ALIPAY_INPUT_CHARSET
        params['trade_no']  = tn
        params['logistics_name'] = u'陕西金倍利嘉商贸有限公司'
    ...
    def create_payurl_cz(self, tn, subject, body, total_fee):
        params = {}
        ...
        params['partner']           = self.ALIPAY_PARTNER
        params['seller_email']      = self.ALIPAY_SELLER_EMAIL
        params['return_url']        = self.ALIPAY_RETURN_CZ_URL
        params['notify_url']        = self.ALIPAY_NOTIFY_CZ_URL
        params['_input_charset']    = self.ALIPAY_INPUT_CHARSET
        params['show_url']          = self.ALIPAY_SHOW_URL
