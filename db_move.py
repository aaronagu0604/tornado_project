...
from model import User as New_User
from model import AdminUser as New_AdminUser
from model import AdminUserLog as New_AdminUserLog
from model import Store as New_Store
from model import StoreAddress as New_StoreAddress
from model import StoreBankAccount as New_StoreBankAccount
from model import StoreArea as New_StoreArea
from model import MoneyRecord as New_MoneyRecord
from model import ScoreRecord as New_ScoreRecord
from model import Category as New_Category
from model import CategoryAttribute as New_CategoryAttribute
from model import CategoryAttributeItems as New_CategoryAttributeItems
from model import Brand as New_Brand
from model import BrandCategory as New_BrandCategory
from model import Product as New_Product
from model import ProductPic as New_ProductPic
from model import ProductAttributeValue as New_ProductAttributeValue
from model import ProductRelease as New_ProductRelease
from model import StoreProductPrice as New_StoreProductPrice
from model import ShopCart as New_ShopCart
from model import Settlement as New_Settlement
from model import Order as New_Order
from model import SubOrder as New_SubOrder
from model import OrderItem as New_OrderItem
from model import Insurance as New_Insurance
from model import InsuranceArea as New_InsuranceArea
from model import InsuranceItem as New_InsuranceItem
from model import InsuranceScoreExchange as New_InsuranceScoreExchange
from model import InsurancePrice as New_InsurancePrice
from model import InsuranceOrderPrice as New_InsuranceOrderPrice
from model import InsuranceOrder as New_InsuranceOrder
from model import Block as New_Block
from model import BlockItem as New_BlockItem
...
def move_brandcategory():
    old_brandcategory = Old_PinPai.select(Old_PinPai.id << brand_map.keys())  # 过滤后只余下新数据库brand对应的PinPai数据
    old_data = [{
